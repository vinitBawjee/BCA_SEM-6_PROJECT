...
export default function Signup_User() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) {
            ...
            try {
                const res = await axios.post(`${import.meta.env.VITE_API_URL}/user/register`, formDataObj, { 
        ...
        <div className={`${css.container}`}>
            <div className={`${css.signup}`}>
                ...
                <div className={`${css.signup_link} border p-3 shadow-sm bg-white text-center`}>
                    <p className="m-0 text-dark">Don't have an account? <Link to="/signup_seller"  style={{color: "#4A90E2"}}>Seller</Link></p>
